...
public class ServiceActivity extends ListActivity {
    ...
    private static String url_all_products = "http://172.16.4.37/android_connect/get_all_products.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        objetosList = new ArrayList<HashMap<String, String>>();
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            ServiceActivity.this, objetosList,
